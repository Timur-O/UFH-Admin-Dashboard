...
<ul id="slide-out" class="sidenav sidenav-fixed">
  ...
  <li><a href="manageads.php"><i class="material-icons">attach_money</i>Manage Ads</a></li>
  <li><a href="analytics.php"><i class="material-icons">insert_chart</i>Analytics</a></li>
  <li><a class="subheader">Affiliate Program Tools</a></li>
  ...
  <li><a class="subheader">Misc. Tools</a></li>
